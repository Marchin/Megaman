...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/guachin1.png", __ASSET__assets_guachin1_png);
		type.set ("assets/guachin1.png", AssetType.IMAGE);
		className.set ("assets/plataforma.png", __ASSET__assets_plataforma_png);
...
@:keep @:bind #if display private #end class __ASSET__assets_guachin1_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_plataforma_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("assets/guachin1.png") #if display private #end class __ASSET__assets_guachin1_png extends lime.graphics.Image {}
@:image("assets/plataforma.png") #if display private #end class __ASSET__assets_plataforma_png extends lime.graphics.Image {}
